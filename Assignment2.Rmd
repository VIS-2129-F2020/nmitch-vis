...
###### Note: Statista reports data for the Andaman, Nicobar, Daman, and Diu Islands together while rnaturalearthhires considers them separately as the Andaman and Nicobar Islands and the Daman and Diu Islands. For the purposes of this project, I divded the data reported by Statista in half and assigned one half each to the Andaman and Nicobar Islands and the Daman and Diu Islands.
...
```{r proportional symbol map, results='hide', message=FALSE}
